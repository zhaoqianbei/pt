...
(
	...
	'std_open_registration_disabled' => "自由注册当前关闭，只允许邀请注册。如果你想加入，请进本站交流群，免费索取。
	<br>备注：进群后，发群主你的邮箱即可，等群主回复你邀请链接！:)
	<br>我们希望您珍惜自己账户，获取他人的分享的同时，分享自己的所得，从而乐在其中。
	<br>若你的账户，不好好养护，它可能会被删除！
	<br>若你在本站行为不端、作弊、严重违法上传等，你的账号及相关记录也可能被删除！",
	'std_account_limit_reached' => "当前账户上限数已到。系统会经常删除不活动的帐户，请过段时间再试...",
	'std_the_ip' => "该IP",
	'std_used_many_times' => "已经被很多帐户使用...<b>".$SITENAME."</br>不允许该IP注册更多账户。",
	...
	'text_normal' => "普通",
	'text_free' => "免费",
	'text_two_times_up' => "2X上传",
	'text_free_two_times_up' => "2X免费",
	'text_half_down' => "50%免费",
	'text_half_down_two_up' => "2X上传&50%免费",
	...
	'text_douban_url_note' => "(来自<strong><a href=\"https://movie.douban.com\">豆瓣电影</a></strong>的链接。如<b>征服荒野</b>的链接是<b>https://movie.douban.com/subject/35050809/</b>)",
	'text_artist' => "艺术家：",
	'text_album' => "专辑名：",
	'title_get_rss' => "获取RSS",
	'text_hot' => "热门",
	...
	'row_subject' => "主题",
	'row_body' => "正文",
	'text_peasant' => "(婴儿)Peasant",
	'text_user' => "(幼儿园)User",
	'text_power_user' => "(小学)Power User",
	'text_elite_user' => "(初中)Elite User",
	'text_crazy_user' => "(高中)Crazy User",
	'text_insane_user' => "(专科)Insane User",
	'text_veteran_user' => "(本科)Veteran User",
	'text_extreme_user' => "(研究生)Extreme User",
	'text_ultimate_user' => "(博士)Ultimate User",
	'text_nexus_master' => "(博士后)Nexus Master",
	'text_vip' => "贵宾",
	'text_uploader' => "发布员",
	'text_retiree' => "养老族",
	...
	'tips_pt'=>'<span class="tal"><a class="fcs" href="/forums.php?action=viewtopic&topicid=10&page=last#pid13" target="_blank"><i class="icon pt-lianjie"></i> 关于PT，从入门到发药</a></span>',
	'tips_zuozhong'=>'<span class="tal"><a class="fcs" href="/forums.php?action=viewtopic&topicid=10&page=last#pid13" target="_blank"><i class="icon pt-lianjie"></i> PT之做种、保钟、辅种相关问题</a></span>',
	'tips_zhiding'=>'<span class="tal ml10"><a class="fcs" href="/forums.php?action=viewtopic&topicid=3&page=p3#pid3" target="_blank"><i class="icon pt-lianjie"></i> 置顶规则</a></span>',
	'tips_yanjin'=>'<span class="tal ml10"><a class="fcr" href="/forums.php?action=viewtopic&topicid=9&page=p11#pid11" target="_blank"><i class="icon pt-lianjie"></i> 严禁上传说明</a></span>',
	'tips_huodong'=>'<span class="tal ml10"><a class="fcr" href="/forums.php?action=viewforum&forumid=7" target="_blank"><i class="icon pt-huodong"></i> 奖励、活动</a></span>'
);
