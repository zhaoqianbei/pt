...
(
	...
	'text_crucial_profile_management_note' => "。改變用戶所有檔案資訊，除了捐赠資訊外（只有",
	'text_can_manage_donation' => "能管理捐赠資訊）。",
	...
	'text_donor_gets' => "捐赠者通過做種能獲得正常情況",
	'text_times_as_many' => "倍的魔力值。預設'2'。設為'0'則將捐赠者和其他用戶同等對待。",
	...
	'row_hundred_gb_credit' => "100.0 GB上傳量",
	'text_hundred_gb_credit_note' => "個魔力值，如果他選取交換100.0 GB上傳量。預設'10000'。",
	'row_hundred_gb_download' => "增加100.0 GB下載量",
	'text_hundred_gb_download_note' => "個魔力值，如果他選取交換100.0 GB下載量。預設'10000'。",
	'row_hundred_gb_reduce' => "減少100.0 GB下載量",
	'text_hundred_gb_reduce_note' => "個魔力值，如果他選取減少100.0 GB下載量。預設'20000'。",
	...
	'row_show_donation' => "開啟捐赠",
	'text_show_donation_note' => "察看捐赠資訊和捐赠排行榜。",
	...
	'text_site_accountant_userid_note' => "填寫數字，如'1'。捐赠者將傳送捐赠資訊短訊至此ID的用戶。",
	'row_alipay_account' => "支付寶賬號",
	'text_alipal_account_note' => "你用于接收捐赠的支付寶賬號，如'yourname@gmail.com'。如果沒有，請留空。",
	'row_paypal_account' => "PayPal賬號",
	'text_paypal_account_note' => "你用于接收捐赠的PayPal賬號，如'yourname@gmail.com'。如果沒有，請留空。",
