...
(
	'std_sorry' => "對不起",
	'std_do_not_accept_donation' => "我們目前不接收捐赠。",
	'std_success' => "成功",
	'std_donation_success_note_one' => "感謝你的捐赠！你的付款已完成。請點擊",
	'std_here' => "這裡",
	'std_donation_success_note_two' => "傳送你的付款資訊給我們，方便我們確認你的捐赠。",
	'head_donation' => "捐赠",
	'text_donate' => "捐赠",
	'std_error' => "錯誤",
	'std_no_donation_account_available' => "沒有設定接收捐赠的賬號。請將此情況告訴管理組。",
	...
	'text_donate_paypal_note' => "1. 選取你的捐赠金額。<br />2. 點擊PayPal按鈕。<br />3. 在PayPal網站完成付款。",
	'text_select_donation_amount' => "請選取你的捐赠金額：",
	'select_choose_donation_amount' => "---選取捐赠金額---",
	...
	'text_after_donation_note_one' => "在完成捐赠后，請一定將你的<b>付款資訊</b>通過站短",
	'text_send_us' => "傳送給我們",
	'text_after_donation_note_two' => "，方便我們確認你的捐赠。",
);
