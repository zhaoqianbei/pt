...
function get_user_class_name($class, $compact = false, $b_colored = false, $I18N = false)
{
    ...
    $class_name = "";
    switch ($class) {
        case UC_PEASANT:{ $class_name = $this_lang_functions['text_peasant'];
                break;}
        case UC_USER:{ $class_name = $this_lang_functions['text_user'];
                break;}
        case UC_POWER_USER:{ $class_name = $this_lang_functions['text_power_user'];
                break;}
        case UC_ELITE_USER:{ $class_name = $this_lang_functions['text_elite_user'];
                break;}
        case UC_CRAZY_USER:{ $class_name = $this_lang_functions['text_crazy_user'];
                break;}
        case UC_INSANE_USER:{ $class_name = $this_lang_functions['text_insane_user'];
                break;}
        case UC_VETERAN_USER:{ $class_name = $this_lang_functions['text_veteran_user'];
                break;}
        case UC_EXTREME_USER:{ $class_name = $this_lang_functions['text_extreme_user'];
                break;}
        case UC_ULTIMATE_USER:{ $class_name = $this_lang_functions['text_ultimate_user'];
                break;}
        case UC_NEXUS_MASTER:{ $class_name = $this_lang_functions['text_nexus_master'];
                break;}
        case UC_VIP:{ $class_name = $this_lang_functions['text_vip'];
                break;}
        case UC_UPLOADER:{ $class_name = $this_lang_functions['text_uploader'];
                break;}
        case UC_RETIREE:{ $class_name = $this_lang_functions['text_retiree'];
                break;}
        case UC_FORUM_MODERATOR:{ $class_name = $this_lang_functions['text_forum_moderator'];
                break;}
        case UC_MODERATOR:{ $class_name = $this_lang_functions['text_moderators'];
                break;}
        case UC_ADMINISTRATOR:{ $class_name = $this_lang_functions['text_administrators'];
                break;}
        case UC_SYSOP:{ $class_name = $this_lang_functions['text_sysops'];
                break;}
        case UC_STAFFLEADER:{ $class_name = $this_lang_functions['text_staff_leader'];
                break;}
    }

    switch ($class) {
        case UC_PEASANT:{ $class_name_color = $en_lang_functions['text_peasant'];
                break;}
        case UC_USER:{ $class_name_color = $en_lang_functions['text_user'];
                break;}
        case UC_POWER_USER:{ $class_name_color = $en_lang_functions['text_power_user'];
                break;}
        case UC_ELITE_USER:{ $class_name_color = $en_lang_functions['text_elite_user'];
                break;}
        case UC_CRAZY_USER:{ $class_name_color = $en_lang_functions['text_crazy_user'];
                break;}
        case UC_INSANE_USER:{ $class_name_color = $en_lang_functions['text_insane_user'];
                break;}
        case UC_VETERAN_USER:{ $class_name_color = $en_lang_functions['text_veteran_user'];
                break;}
        case UC_EXTREME_USER:{ $class_name_color = $en_lang_functions['text_extreme_user'];
                break;}
        case UC_ULTIMATE_USER:{ $class_name_color = $en_lang_functions['text_ultimate_user'];
                break;}
        case UC_NEXUS_MASTER:{ $class_name_color = $en_lang_functions['text_nexus_master'];
                break;}
        case UC_VIP:{ $class_name_color = $en_lang_functions['text_vip'];
                break;}
        case UC_UPLOADER:{ $class_name_color = $en_lang_functions['text_uploader'];
                break;}
        case UC_RETIREE:{ $class_name_color = $en_lang_functions['text_retiree'];
                break;}
        case UC_FORUM_MODERATOR:{ $class_name_color = $en_lang_functions['text_forum_moderator'];
                break;}
        case UC_MODERATOR:{ $class_name_color = $en_lang_functions['text_moderators'];
                break;}
        case UC_ADMINISTRATOR:{ $class_name_color = $en_lang_functions['text_administrators'];
                break;}
        case UC_SYSOP:{ $class_name_color = $en_lang_functions['text_sysops'];
                break;}
        case UC_STAFFLEADER:{ $class_name_color = $en_lang_functions['text_staff_leader'];
                break;}
    }
...
function commenttable($rows, $type, $parent_id, $review = false)
{
    ...
    foreach ($rows as $row) {
        ...
        print("</tr>\n");
        $actionbar = "<a href=\"comment.php?action=add&amp;sub=quote&amp;cid=" . $row[id] . "&amp;pid=" . $parent_id . "&amp;type=" . $type . "\"><i class=\"f_quote icon pt-quote\" alt=\"Quote\" title=\"" . $lang_functions['title_reply_with_quote'] . "\"></i></a>" .
            "<a href=\"comment.php?action=add&amp;pid=" . $parent_id . "&amp;type=" . $type . "\"><i class=\"f_reply  icon pt-huifu ml10\" alt=\"Add Reply\" title=\"" . $lang_functions['title_add_reply'] . "\"></i></a>" . (get_user_class() >= $commanage_class ? "<a href=\"comment.php?action=delete&amp;cid=" . $row[id] . "&amp;type=" . $type . "\"><i class=\"f_delete icon pt-delete ml10\" alt=\"Delete\" title=\"" . $lang_functions['title_delete'] . "\"></i></a>" : "") . ($row["user"] == $CURUSER["id"] || get_user_class() >= $commanage_class ? "<a href=\"comment.php?action=edit&amp;cid=" . $row[id] . "&amp;type=" . $type . "\"><i class=\"f_edit icon pt-bianji ml10\" alt=\"Edit\" title=\"" . $lang_functions['title_edit'] . "\"></i>" . "</a>" : "");
        print("<tr><td class=\"toolbox\"> " . ("'" . $userRow['last_access'] . "'" > $dt ? "<i class=\"f_online  icon pt-zaixian fcg mr5\" alt=\"Online\" title=\"" . $lang_functions['title_online'] . "\" ></i>" : "<i class=\"f_offline icon pt-zaixian fc2\" alt=\"Offline\" title=\"" . $lang_functions['title_offline'] . "\"></i>") . "<a href=\"sendmessage.php?receiver=" . htmlspecialchars(trim($row["user"])) . "\"><i class=\"f_pm icon pt-xinxi ml10\" alt=\"PM\" title=\"" . $lang_functions['title_send_message_to'] . htmlspecialchars($userRow["username"]) . "\"></i></a><a href=\"report.php?commentid=" . htmlspecialchars(trim($row["id"])) . "\"><i class=\"f_report icon pt-jubao ml5\" alt=\"Report\" title=\"" . $lang_functions['title_report_this_comment'] . "\" ></i></a></td><td class=\"toolbox\" align=\"right\">" . $actionbar . "</td>");
...
function torrenttable($res, $variant = "torrent", $mysnatched = array())
{
    ...
    if ($variant == 'rssdown') {
        echo '<form action="myrss.php?batch=1" method="post">';
    }
...
$count_get = 0;
    ...
    if ($variant == 'rssdown') {
        echo '<td class="colhead"><input type="checkbox" name="rssall" onclick="BatchSelect(this,\'torrenttable\')" /></td>';
    }
...
<td class="colhead"><a href="?<?php echo $oldlink ?>sort=5&amp;type=<?php echo $link[5] ?>"><i class="size" alt="size" title="大小"></i>大小</td>
<td class="colhead"><a href="?<?php echo $oldlink ?>sort=7&amp;type=<?php echo $link[7] ?>"><i class="seeders" alt="seeders" title="种子数"></i>做种</a></td>
<td class="colhead"><a href="?<?php echo $oldlink ?>sort=8&amp;type=<?php echo $link[8] ?>"><i class="leechers" alt="leechers" title="下载数"></i>下载</a></td>
<td class="colhead"><a href="?<?php echo $oldlink ?>sort=6&amp;type=<?php echo $link[6] ?>"><i class="snatched" alt="snatched" title="完成数"></i>完成</a></td>
...
$caticonrow = get_category_icon_row($CURUSER['caticon']);
    ...
    while ($row = mysql_fetch_assoc($res)) {
        ...
        if ($variant == 'rssdown') {
            printf('<td class="rowfollow" valign="middle"><input type="checkbox" name="rss[]" value="%d" onclick="BlockSelect(event.shiftKey,this)" /></td>', $row['id']);
        }
    ...
    print("</table>");
    if ($variant == 'rssdown') {
        printf('<input type="submit" name="remove" value="%s" /></form>', $lang_functions['title_delrssdown_torrent']);
    }
...
function get_torrent_promotion_append($promotion = 1, $forcemode = "", $showtimeleft = false, $added = "", $promotionTimeType = 0, $promotionUntil = '')
{
    ...
    if (($CURUSER['appendpromotion'] == 'word' && $forcemode == "") || $forcemode == 'word') {
        ...
        if (($promotion == 2 && get_global_sp_state() == 1) || get_global_sp_state() == 2) {
            $sp_torrent = " <font class='promotion free' >" . $lang_functions['text_free'] . "</font>";
        } elseif (($promotion == 3 && get_global_sp_state() == 1) || get_global_sp_state() == 3) {
            $sp_torrent = " <font class='promotion twoup' >" . $lang_functions['text_two_times_up'] . "</font>";
        } elseif (($promotion == 4 && get_global_sp_state() == 1) || get_global_sp_state() == 4) {
            $sp_torrent = " <font class='promotion twoupfree' >" . $lang_functions['text_free_two_times_up'] . "</font>";
        } elseif (($promotion == 5 && get_global_sp_state() == 1) || get_global_sp_state() == 5) {
            $sp_torrent = " <font class='promotion halfdown' >" . $lang_functions['text_half_down'] . "</font>";
        } elseif (($promotion == 6 && get_global_sp_state() == 1) || get_global_sp_state() == 6) {
            $sp_torrent = " <font class='promotion twouphalfdown' >" . $lang_functions['text_half_down_two_up'] . "</font>";
        } elseif (($promotion == 7 && get_global_sp_state() == 1) || get_global_sp_state() == 7) {
            $sp_torrent = " <font class='promotion thirtypercent' >" . $lang_functions['text_thirty_percent_down'] . "</font>";
        }
...
function buildStickySQL($type, $until = false)
{
    ...
    if ($type >= 1) {
        ...
        if ($until) {
            $sql .= sprintf(', `pos_until` = %s', sqlesc($until));
        }
...
function EchoRow($class = '')
{
    ...
    foreach ($cells as $cell) {
        $s .= sprintf('<td%s>%s</td>', $class, $cell);
    }
...
class Invitation
{
    ...
    public static function getTempInvite($userid)
    {
        ...
        if (($invites = $Cache->get_value($key)) === false) {
            ...
            while ($row = mysql_fetch_assoc($res)) {
                $invites[$row['expiration'] + $row['id']] = array('id' => $row['id'], 'q' => $row['qty'], 'e' => $row['expiration']);
            }

            $Cache->cache_value($key, $invites, 3600);
        }
        foreach ($invites as $i => $invite) {
            if ($invite['q'] <= 0 || $invite['e'] <= TIMENOW) {
                unset($invites[$i]);
            }
            // remove bad entries
        }
    ...
    public static function addTempInvites($users, $amount, $expiration)
    {
        $inserts = array();
        foreach ($users as $user) {
            $inserts[] = sprintf('(%u, %u, %u)', $user, $amount, $expiration);
        }
