...
<td class="embedded"><a href="http://img.24di.cn/" title="欢迎使用" target="_blank" class="ml20 bb p55 fcf br2">图床</a> (不会用点我)</td> 
</tr>
</table>
</td>
</tr>
...
{
    global $CURLANGDIR;
    return "<img class=\"db\" src=\"" . $url . "\" alt=\"avatar\" width=\"80px\" onload=\"check_avatar(this, '" . $CURLANGDIR . "');\" />";
}
