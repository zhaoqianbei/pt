...
<td class="embedded"><a href="http://img.pttime.org/" title="欢迎使用" target="_blank" class="ml20 bb p55 fcf br2">图床</a> (<a href="https://www.zhaoqianbei.com/Index/xiaokeZhuye/k/81631476" target="_blank">不会用点我</a>)</td>
</tr>
</table>
</td>
</tr>
...
function return_category_image($categoryid, $link = "")
{
    ...
    if ($catImg[$categoryid]) {
        ...
        $catImg[$categoryid] = $catimg = "<img src=\"http://img.pttime.org/2020/07/28/71ef92e6f4d62.png\" alt=\"" . $categoryrow["name"] . "\" title=\"" . $categoryrow["name"] . "\" />"."<span" . ($categoryrow['class_name'] ? " class=\"category " . $categoryrow['class_name'] . "\"" : "") . " alt=\"" . $categoryrow["name"] . "\" title=\"" . $categoryrow["name"] . "\"></span>";
    }
    if ($link) {
