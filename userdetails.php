...
// 用户详情等级图片
tr_small($lang_userdetails['row_class'], "<i alt=\"".get_user_class_name($user["class"],false,false,true)."\" title=\"".get_user_class_name($user["class"],false,false,true)."\">".get_user_class_name($user["class"],false,false,true)."</i> ".($user[title]!=="" ? "&nbsp;".htmlspecialchars(trim($user["title"]))."" :  ""), 1);
